...
class Services_m extends CI_Model
{
	...
	{
		$this->db->select('p.id as product_id,p.image,p.milage,p.price,p.year,p.created_at,c.name_'.$lang.' as country_name,sc.name_'.$lang.' as sub_category_name,cat.name_'.$lang.' as category_name');
	...
	{
		$this->db->select('p.id as product_id,p.price,p.user_id as seller_id,p.year,p.milage,p.inspected,p.cylinders,p.gears,p.sun_roof,p.min_bid,p.serial_num,p.description,p.exterior_color_id,p.interior_color_id,c.name_'.$lang.' as country_name,cat.name_'.$lang.' as category_name ,sc.name_'.$lang.' as sub_category_name');
