			...
			<div class="row">
				<div class="col-12">
					<div class="breadcrumb-content text-center">
						<h1 class="breadmome-name">Profile</h1>
						<ul>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					...
					<ul class="nav nav-pills nav-stacked flex-column">
						<li class="active"><a href="#profile" data-toggle="pill"><i class="fa fa-user" aria-hidden="true"></i>Profile</a>
						</li>
						<li class="edit" data-toggle="modal" data-target="#add" data-id="<?php echo $userdata['id'] ;?>
						">
						<a href="javascript:" data-toggle="pill"><i class="fa fa-key" aria-hidden="true"></i>Password
						</a></li>
						<!-- <div class="col-md-2">
							<button type="button" class="btn btn-primary waves-effect waves-light edit" data-toggle="modal" data-target="#add" data-id="<?php echo $userdata['id'] ;?>" style="float: none"> <span class="icofont icofont-ui-edit">Edit Password</span>
						</div> -->
		

						<li ><a href="#favorites" data-toggle="pill"><i class="fa fa-heart"></i>My Favorites</a></li>

						<li ><a href="#products" data-toggle="pill"><i class="fa fa-plus-square-o" aria-hidden="true"></i>My Products</a></li>

						<li><a href="#bids" data-toggle="pill"><i class="fa fa-plus-square-o" aria-hidden="true"></i>My bids</a></li>
					</ul>
				...
				<div class="tab-pane" id="favorites">
						<div class="entry-header">
							<h1 class="entry-title mb-20">My Favorites</h1>
						</div>
							...
							<?php if(@$my_favorites){
								...
								<div class="single-category-product mt-40">
									<div class="single-category-product-img">
										<a href="<?php echo  base_url(); ?>home/view_deals/<?php echo $product['product_id']; ?>"><img src="<?php echo base_url().$product['image']; ?>" alt="" /></a>
									</div>
									<div class="single-category-product-info"><a href="javascript:"><h2><?php echo $product['category_name']; ?></h2></a>
										...
										<div class="new-product-action2 category-cart"> <a href="<?php echo  base_url(); ?>home/view_deals/<?php echo $product['product_id']; ?>" class="bg-black"><span class=""></span>View Deal</a> 
...
<!-- 									<div class="single-close">
	<a href="#"><i class="fa fa-times"></i></a>
				...
				<div class="tab-pane" id="products">
						...
						<div class="entry-header">
							<h1 class="entry-title mb-20">My Products</h1>
						</div>
							...
							<?php if(@$my_products){
								...
								<div class="single-category-product mt-40">
									...
									<div class="single-category-product-info"><a href="javascript:"><h2><?php echo $product['category_name']; ?></h2></a>
										...
										<a href="javascript:" class="bg-black" onclick="openNav('<?php echo $id; ?>')"><span style="cursor:pointer" ></span>View Bidders</a>
...
<!-- 									<div class="single-close">
	<a href="#"><i class="fa fa-times"></i></a>
							...
							<?php } }else{ ?>
										<p class='text-center'>You did't posted any products !</p>
							<?php } ?>
			...
			<div class="tab-pane" id="bids">
					...
					<div class="entry-header">
						<h1 class="entry-title mb-20">My Bids</h1>
					</div>
	...
	<a href="#"><i class="fa fa-times"></i></a>
				...
				<div class="tab-pane active" id="profile">
					<div class="login-area ">
						...
						<div class="entry-header">
						<h1 class="entry-title mb-20">Manage Account</h1>
						</div>
							...
							<div class=" col-lg-8 col-md-8 col-sm-12 col-xs-12">
								...
								<div class="login-form signup-0">
									<div class="row">
										...
										<button type="button" class="btn btn-primary waves-effect waves-light add" data-toggle="modal" data-target="#add" data-id="<?php echo $userdata['id'] ;?>" style="float: none"> <span class="icofont icofont-ui-edit">Edit Details</span>
										</button>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<p>	
												...
												<sub id="switch"><?php echo ($f) ? 'you will notify' : "you wont't notify" ; ?></sub>
											</p>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="entry-header">
								<h2 class="entry-title mb-20">Package Details</h2>
								</div>
		...
		<?php } ?>	
		 ...
		 <div class="row col-sm-4">
		  <div >
			...
			<?php } ?>
			<p style="color: white"><?php echo $bid['bid_value'].' SAR - '.$bid['created_at'] ; ?></p>
		  </div>
		</div> 
	<?php } ?>
   </div>
...
$('#notification_flag').change(function(){
    ...
    {
    	$status = 1 ;
    	$("#switch").html('you will notify') ;
    }
    else
    {
    	$status = 0 ;
    	$("#switch").html("you won't notify") ;
    }
