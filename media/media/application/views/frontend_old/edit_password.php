...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Edit Password</h4>
        ...
        <div class="form-group row">
           ...
           <div class="form-group">
            <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Old Password</label>
            <div class="col-sm-8">
                <input type="password" id="old_password"  name="old_password" onkeyup="check_old_pass(this.value)"  class="form-control" placeholder="Please enter old password">
         ...
         <div class="form-group row">
            <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">New Password</label>
             <div class="col-sm-8">
                <p id="valid_error" class="hide" style="color: red">Password should contain atleast 6 chars !</p>
                <input type="password" id="new_password" placeholder="New Password"  name="password" onkeyup="check_new_pass(this.value)""  class="form-control" disabled="">
             </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Confirm Password</label>
             <div class="col-sm-8">
                <input type="password" id="confirm_password" placeholder="Confirm Password" onkeyup="confirm_pass(this.value)"  name="confirm_password"  class="form-control" disabled="">
...
<!--         <div class="form-group row">
    ...
    <div class="col-sm-8">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary waves-effect waves-light insert" id="save_pass" disabled="">Save changes</button>
