    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-body">
           ...
           <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Name</label>
            <div class="col-sm-8">
         ...
         <div class="form-group row">
            <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Phone Number</label>
             <div class="col-sm-8">
        ...
        <div class="form-group row">
            <div class="form-group">
             <label for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Address</label>
             <div class="col-sm-8">
