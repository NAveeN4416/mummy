      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8"> 
           ...
           <div class="dropdown header-left-menu">
            ...
            <button class="btn btn-default header-left-menu dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> City <i class="fa fa-angle-down"></i> </button>
            ...
            <nav>
              ...
              <ul>
               ...
               <!-- <li><a href="javascript:">Today Deals</a> </li>
                ...
                <li class="<?php echo (@$page=='sell_product') ? 'active' : '' ; ?>"><a href="<?php echo  base_url(); ?>home/sell_product""><?php echo $this->lang->line('h_new_deals'); ?></a> </li>
    ...
    <div class="row">
            ...
            <div class="category-menu-list" id="cate-toggle">
              ...
              <ul>
                <?php foreach ($categories as $key => $category) {  ?>
                  ...
                  <li class="right-menu"><a href="<?php echo base_url(); ?>home/models/<?php echo $category['id'] ; ?>"> <img src="<?php echo base_url().$category['image']; ?>" alt="" /> <?php echo $category['name_'.$lang]; ?></a> </li>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="menu-search-box menu-search-box-2">
          ...
          <input type="text" id="search" class="form-control my-control" placeholder="Eg: Red, model, city, year" />
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 p-l-no">
        ...
        <div class="menu-search-box menu-search-box-3">
          ...
          <div class="dropdown first-box">
            ...
            <button class="btn btn-primary " type="button"  data-toggle="modal" data-target="#myModal"><?php echo $this->lang->line('h_advanced'); ?><br>
          ...
          <div class="dropdown first-box lastbox">
            ...
            <a class="btn btn-primary auction-car" href="<?php echo base_url(); ?>home/sell_product"><?php echo $this->lang->line('h_auction'); ?></a>
