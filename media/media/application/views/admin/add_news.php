...
.popover 
{
        ...
        <div class="main-header">
          ...
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            <li class="breadcrumb-item">
			 ...
			 <li class="breadcrumb-item"><a href="#:" >Add/Edit News</a></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text">Add/Edit News</h5></div>
  ...
  -->        
                ...
                <div class="form-group row">
                  ...
                  <?php  if(@$value){ ?>
                   ...
                   <?php   } ?>
                <div class="form-group row">
                     <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">News Image</label>
                    <div class="col-sm-9">
            ...
            var validator = $("#insert_services").validate();
                ...
                if(validator.form() == true){
                    ...
                    $.ajax({                
                        ...
                        url: "<?php echo base_url();?>admin/save_data/news",
                        type: "POST",
                        data: data,
