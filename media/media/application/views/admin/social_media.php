      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-header"><h5 class="card-header-text">Social Media Management</h5>
             <span><button class="btn btn-success fa fa-plus add_category" data-name="<?php echo @$current_page; ?>" style="margin-left:69%"> Link </button></span>
                      ...
                      foreach($social_media as $media) {
                          ...
                          if ($media["status"] == "1") {
                              ...
                              <tr id="hide<?php echo $media["id"] ; ?>">
                                  ...
                                  <td><?php echo ($media['type']==1) ? 'Social Media' : 'Ministry Of Communcation' ; ?></td>

                                  <td style="width:100px;"><?php echo ucfirst($media["title"]) ; ?></td> 

                                  <td><a href="<?php echo $media["link"] ; ?>" target="blank"><button class="btn btn-sm btn-success">Go to Site</button></a></td> 
