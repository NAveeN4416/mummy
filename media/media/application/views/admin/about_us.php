        ...
        <div class="card">
          ...
          <div class="card-block">
              ...
              <form id="insert_services">                         
                ...
                <?php  if(@$about_us){ ?>
                   <img src="<?php echo base_url();?><?php echo @$about_us['image1'];?>" height=100px;>
                      <input type="hidden" name="old_image1" value="<?php echo @$about_us['image1'];?>"> 
                <?php   } ?>
                <div class="form-group row">
                     <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Image 1</label>
                    <div class="col-sm-9">
              ...
              <hr>
                ...
                <div class="form-group row">
                  ...
                  <?php  if(@$about_us){ ?>
                   <img src="<?php echo base_url();?><?php echo @$about_us['image2'];?>" height=100px;>
                      <input type="hidden" name="old_image2" value="<?php echo @$about_us['image2'];?>"> 
                   <?php   } ?>
                <div class="form-group row">
                     <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Image 2</label>
                    <div class="col-sm-9">
            ...
            <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Title 3 (En)*</label>
                    <div class="col-sm-9">
                        <input type="text"  id="title3_en" name="data[title3_en]"  class="form-control"  value="<?php echo @$about_us['title3_en'];?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Title 3 (Ar)*</label>
                    <div class="col-sm-9">
                        <input type="text"  id="title3_ar" name="data[title3_ar]"  class="form-control" value="<?php echo @$about_us['title3_ar'];?>">
                    </div>
                </div>


                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Content 3 (En)*</label>
                    <div class="col-sm-9">
                        <textarea  id="content3_en" name="data[content3_en]"  class="form-control ckeditor" placeholder="Content" rows="10" cols="10"><?php echo @$about_us['content3_en'];?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Content 3 (Ar)*</label>
                    <div class="col-sm-9">
                        <textarea  id="content3_ar" name="data[content3_ar]"  class="form-control ckeditor" placeholder="Content" rows="10" cols="10"><?php echo @$about_us['content3_ar'];?></textarea>
                    </div>
                </div>

                  <?php  if(@$about_us){ ?>
                   <img src="<?php echo base_url();?><?php echo @$about_us['image3'];?>" height=100px;>
                      <input type="hidden" name="old_image3" value="<?php echo @$about_us['image3'];?>"> 
                   <?php   } ?>
                <div class="form-group row">
                     <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Image 3</label>
                    <div class="col-sm-9">
...
$("#insert_services").validate({       
    			...
    			rules: 
          {
                ...
                "data[title3_en]"   : "required",
                "data[title3_ar]"   : "required",
        				"data[content1_en]":{
            ...
            messages : 
            {
                    ...
                    "data[content3_en]"   : "Required",
                    "data[content3_ar]"   : "Required",
            },       
        ...
        var validator = $("#insert_services").validate();
            ...
            if(validator.form() == true){
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_about_us",
                    type: "POST",
                    data: data,
