...
.popover 
{
        ...
        <div class="main-header">
          ...
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            <li class="breadcrumb-item">
			 ...
			 <li class="breadcrumb-item"><a href="#:" >Add/Edit Exhibition</a></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text">Add/Edit Exhibition</h5></div>
          <div class="card-block">
              ...
              <form id="insert_services">                         
                ...
                <div class="form-group row">
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Duration (Ar)*</label>
                    <div class="col-sm-9">
                        <input type="text"  id="duration" name="data[duration]" class="form-control"  value="<?php echo @$value['duration'];?>">
                    </div>
                </div>
<!--                
                <div class="form-group row">
...
-->                
                ...
                <div class="form-group row">
                  ...
                  <?php  if(@$value){ ?>
                   ...
                   <?php   } ?>
                <div class="form-group row">
                     <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Exhibition Image</label>
                    <div class="col-sm-9">
            ...
            var validator = $("#insert_services").validate();
                ...
                if(validator.form() == true){
                    ...
                    $.ajax({                
                        ...
                        url: "<?php echo base_url();?>admin/save_data/exhibitions",
                        type: "POST",
                        data: data,
