...
<!-- <?php echo base_url(); ?>admin/add_story -->
          <div class="card-header"><h5 class="card-header-text">News</h5>
            <a href="<?php echo base_url(); ?>admin/add_news"> <span><button class="btn btn-success fa fa-plus" data-name="<?php echo @$current_page; ?>" style="margin-left:70%">Add News</button></span>
            </a>	
                                   ...
                                   <td style="white-space: nowrap; width: 1%;">
                                      <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                          <div class="btn-group btn-group-sm" style="float: none;">
                                              <a href="<?php echo base_url().'admin/add_news/'.$blog['id']; ?>">
   ...
   <script>     
    ...
    { 
          var id = $(this).data('id');
              ...
              swal({title: 'Delete This News ?', showCancelButton: true}).then(result => {
                if (result.value) 
                {
                ...
                {
                   $.ajax({                
                        url: "<?php echo base_url();?>admin/delete/news",
                        type: "POST",
                        data: {id:id},
