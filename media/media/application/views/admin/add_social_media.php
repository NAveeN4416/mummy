    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <form id="insert">
            ...
            <div class="form-group row">
                <label class="col-xs-4 col-form-label form-control-label">Type</label>
                <div class="col-sm-8">
                        <select class="form-control" name="data[type]">
                          <option value="1" <?php if(isset($media['type'])) { if($media['type'] == "1"){ echo "selected";}}  else { echo "selected"; } ?>>Social Media</option>
                          <option value="2" <?php if(isset($media['type'])) { if($media['type'] == "2"){ echo "selected";}} ?>>Minitsry Of Communication</option>
                    </select>
                </div>    
            </div>                
