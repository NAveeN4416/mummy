        ...
        <div class="modal-body">
            ...
            <div class="col-sm-8">
                ...
                <?php foreach($countries as $key=>$country) { ?>
                    <option value="1" <?php echo (@$country['id'] == @$value['country_id']) ? "selected" : '' ; ?>> <?php echo (@$country['name']) ; ?></option>
                <?php } ?>
                </select>
            </div>    
            </div>
           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" id="name_en"  name="data[name_en]" class="form-control" value="<?php echo @$value['name_en'];?>">
            </div>
            </div>
            </div>
            ...
            <div class="col-sm-8">
                <select class="form-control" name="data[status]">
                    <option value="1" <?php echo (@$value['status'] == 0) ? "" : 'selected' ; ?> >Active</option>
                    <option value="0" <?php echo (@$value['status'] == 1) ? "" : 'selected' ; ?> >InActive</option>
                </select>
            </div>    
            </div>
