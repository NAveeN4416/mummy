...
.popover 
{
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="main-header">
          <h4>Add/Edit Successfull Stories</h4>
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            <li class="breadcrumb-item">
			 ...
			 <li class="breadcrumb-item"><a href="#:" >Add/Edit Successfull Stories</a></li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text">Add/Edit Successfull Stories</h5></div>
        ...
        var validator = $("#insert_services").validate();
            ...
            if(validator.form() == true){
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_data/stories",
                    type: "POST",
                    data: data,
