...
<head>
	...
	<!-- Favicon icon -->
	<link rel="shortcut icon" href="https://www.volivesolutions.com/media/img/logo-light.png" tppabs="http://ableproadmin.com/light/vertical/assets/images/favicon.png" type="image/x-icon">
	<link rel="icon" href="https://www.volivesolutions.com/media/img/logo-light.png" tppabs="http://ableproadmin.com/light/vertical/assets/images/favicon.ico" type="image/x-icon">
				...
				<div class="login-card card-block">
					...
					<span  id="forgot_msg"> </span>
						...
						<div class="text-center">
							<img src="https://www.volivesolutions.com/media/img/logo-light.png" style="width:80px;">
						</div>
