    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-header"><h5 class="card-header-text">Privacy&Policy Management</h5></div>
          ...
          <div class="card-block">
              ...
              <form id="insert_services">                         
                 ...
                 <div class="form-group row">
                    ...
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Privacy Content(En)*</label>
                ...
                <div class="form-group row">
                    ...
                    <label for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Privacy Content(Ar)*</label>
        ...
        var validator = $("#insert_services").validate();
            ...
            if(validator.form() == true){
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_static_data/privacy",
