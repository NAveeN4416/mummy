...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	function sp_send_notification_android($registration_ids, $data){
		...
		$headers = array (
		        'Authorization: key=' . "AIzaSyCW-ybCTU-We2EEiwRZ00IfvD_ahbefRqc",
	...
	function sp_send_notification_ios($device_token, $data)
	{ 
		...
		//stream_context_set_option($ctx, 'ssl', 'local_cert',"TechniqueSPDev.pem");
		stream_context_set_option($ctx, 'ssl', 'local_cert',"TechniqueSPPro.pem");
